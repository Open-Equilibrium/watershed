...
- **ADR-0061** | 2026-07-14 | Accepted | M1 uses exact-pinned `noyalib` 0.0.15 as its sole YAML 1.2 parser behind a private fail-closed Safe-YAML boundary; no fallback parser — `SECURITY.md`.

...
- **ADR-0054 / ADR-0067** | 2026-07-01 / 2026-07-17 | Accepted | M1 caps registry scans at 1,024 entries / 16 MiB, each YAML file at 128 KiB, the selected unique transitive closure at 1 MiB, and session logs at 16 MiB; tail validates append-only suffixes and near-limit closures must preserve the 10 MiB/top-level Loop memory budget — Loop Agent V-Spec, `PERFORMANCE.md`.

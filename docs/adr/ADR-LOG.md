...
- **ADR-0054 / ADR-0067** | 2026-07-01 / 2026-07-17 | Accepted | Registry scan, YAML-file and selected-closure bounds remain; their exact values are canonical in the Loop Agent V-Spec, and the active-loop memory budget is canonical in `PERFORMANCE.md`.

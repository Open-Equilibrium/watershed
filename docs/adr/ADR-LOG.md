...
- **ADR-0053** | 2026-07-01 | Superseded by ADR-0068 | The former 64-level composition cap was replaced by the measured D-068 workload limits — Loop Agent V-Spec.
...
- **ADR-0068** | 2026-07-18 | Accepted | D-068 fixes depth 16, direct fan-out 32, 512 cumulative invocations, 155,750 cumulative events, 32 process-wide live invocations and measured byte/bundle limits; canonical JSONL rotates at 16 MiB instead of ending the session, and the former 10 MiB stream cap is removed — `PERFORMANCE.md`, `PROTOCOL.md`, Loop Agent V-Spec.

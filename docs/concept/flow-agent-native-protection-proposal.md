...
**Replacement integrated; native product verification pending.** [SECURITY.md](../../SECURITY.md#accepted-flow-agent-security-target) owns the guarantees and exclusions. This design owns this installation's protected inventory and admission invariant for Linux Bubblewrap/seccomp and Mac Seatbelt. [PROTOCOL.md](../../PROTOCOL.md#m12-executor-protocol-adr-0146-adr-0160-adr-0161-adr-0162) owns the integrated wire/backend mechanics; [TESTING.md](../../TESTING.md#m12-transition-and-executor-evidence) owns native status and historical feasibility observations. Future features belong only to the [roadmap](../../PLAN.md#later-flow-agent-roadmap).
...
The integrated incremental admission and descriptor contract are recorded in [PROTOCOL.md](../../PROTOCOL.md#m12-executor-protocol-adr-0146-adr-0160-adr-0161-adr-0162). The inventory covers the selected home, platform stores and required program images; complete native product verification remains pending.

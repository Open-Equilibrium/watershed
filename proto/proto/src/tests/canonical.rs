...
fn canonical_event_jsonl_sorts_keys_and_ends_with_lf() {
    ...
    assert_eq!(
        jsonl,
        "{\"event_id\":\"evt-001\",\"event_type\":\"tool.started\",\"flow_id\":\"flow-001\",\"payload\":{\"allowed_parameters\":[],\"tool_id\":\"read-file\",\"tool_kind\":\"predefined-command\",\"tool_name\":\"ReadFile\"},\"protocol_version\":\"0\",\"sequence\":1,\"session_id\":\"smoke001\",\"source\":\"flow-agent-cli\",\"timestamp\":\"2026-01-01T00:00:00Z\"}\n"
    );
}

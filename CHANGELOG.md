...
- D-015 fixture event-stream details captured in `TESTING.md` and `PROTOCOL.md` for golden streams, event envelopes, invocation IDs, sandbox defaults and connection payload pairing.
- v0 building-block, registry, session-log and policy-artifact contracts captured in `PROTOCOL.md`, `SECURITY.md`, `TESTING.md` and checked fixtures.

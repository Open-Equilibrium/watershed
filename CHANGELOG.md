...
## [Unreleased]
### Added
- Governance and spec set: README, VISION, PLAN, PROTOCOL, SECURITY, TESTING, PERFORMANCE, GLOSSARY, AGENTS, V-Spec concept files, open-decisions dashboard, ADR log (ADR-0001…ADR-0055).
...
- Drift fixes: Liquid V-Spec performance numbers realigned to the ADR-0014 tiered budgets; ADR range in this changelog corrected to ADR-0001…ADR-0055.
